...
import { SSSMSidebarService } from './sidebar.service';
import { SSSMConfigService } from 'src/app/services/common/config-service';



@Component({
    selector     : 'sssm-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class SSSMSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._sssmConfigService.config
            ...
            .subscribe((config) => {
                this._sssmConfig = config;
            });

        // Register the sidebar
        this._sssmSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._sssmSidebarService.unregister(this.name);
