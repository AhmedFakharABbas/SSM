...
import { SSSMPerfectScrollbarGeometry, SSSMPerfectScrollbarPosition } from './sssm-perfect-scrollbar.interfaces';
import { SSSMConfigService } from 'src/app/services/common/config-service';

@Directive({
    selector: '[sssmPerfectScrollbar]'
})
export class SSSMPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set sssmPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get sssmPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.sssmPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.sssmPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): SSSMPerfectScrollbarGeometry
    {
        return new SSSMPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): SSSMPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new SSSMPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
