...
export class SSSMInnerScrollDirective implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _sssmMediaMatchService: SSSMMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._sssmMediaMatchService.onMediaChange
