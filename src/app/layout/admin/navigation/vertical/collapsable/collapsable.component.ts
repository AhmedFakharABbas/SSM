...
import { SSSMAnimations } from '../../../animations';
...
export class SSSMNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._sssmNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._sssmNavigationService.onItemCollapsed.next(this.item);
        this._sssmNavigationService.onItemCollapseToggled.next();
    }
